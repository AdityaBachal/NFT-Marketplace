const { expect } = require("chai");     // chai is a token
const { ethers } = require("hardhat");  // hardhat - compile the contracts n run them on development network

describe("KBMarket", function(){
  it("Should mint and trade NFTs", async function(){

    // test to receive contract addresses
    // after running this contract address will be visible in config.js
